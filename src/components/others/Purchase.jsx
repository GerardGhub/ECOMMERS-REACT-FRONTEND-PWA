          ...
          <Row className="p-2">
            ...
            >
              ...
              <p className="section-title-contact">
                I started to learn how to code when I was a 2nd year college ,
                at my first job as IT Specialist I experience all the different
                type of MIS work such as Networking , CCTV Configuration,
                Graphic Designing, Server Configuration, Hardware & Software
